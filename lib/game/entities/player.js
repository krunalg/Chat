...
.defines(function(){
	...
	switch(player.facing)
	{
	    case 'left':
		player.vel.x = -speed;
		//player.currentAnim = player.anims.walkLeftA;
		break;
	    case 'right':
		player.vel.x = +speed;
		//player.currentAnim = player.anims.walkRightA;
		break;
	    case 'up':
		player.vel.y = -speed;
		//player.currentAnim = player.anims.walkUpA;
		break;
	    case 'down':
		player.vel.y = +speed;
		//player.currentAnim = player.anims.walkDownA;
		break;
	}
    };
	...
	/*player.messagebox = "sending sockedwdt:\n"
			  + player.facing + "\n"
			  + player.gamename
			    ;*/
    }
	...
	return url;
		...
		EntityPlayer = ig.Entity.extend({
			...
			// add the animations
			var animOffset = 0;
			//var animOffset = 0.005;
			this.addAnim( 'walkUpA', 0.13125+animOffset, [2,0,0] );
			this.addAnim( 'walkUpB', 0.13125+animOffset, [1,0,0] );
			this.addAnim( 'walkDownA', 0.13125+animOffset, [8,6,6] );
			this.addAnim( 'walkDownB', 0.13125+animOffset, [7,6,6] );
			this.addAnim( 'walkLeftA', 0.13125+animOffset, [5,3,3] );
			this.addAnim( 'walkLeftB', 0.13125+animOffset, [4,3,3] );
			this.addAnim( 'walkRightA', 0.13125+animOffset, [5,3,3] );
			this.addAnim( 'walkRightB', 0.13125+animOffset, [4,3,3] );
