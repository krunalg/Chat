...
.defines(function(){
	...
	socket.emit('receiveMove',xstart,ystart,direction,client);
		...
		EntityPlayer = ig.Entity.extend({
			...
			// add the animations
			this.addAnim( 'walkup', 0.13125, [2,0,1,0] );
			this.addAnim( 'walkdown', 0.13125, [8,6,7,6] );
			this.addAnim( 'walkleft', 0.13125, [5,3,4,3] );
			this.addAnim( 'walkright', 0.13125, [5,3,4,3] );
			...
			socket.emit('initializePlayer', this.pos.x, this.pos.y, this.facing, this.gamename); 
		    },
